...
Elproblema utliza funciones en las que se usan diferentes tipos de variables. */
...
int f1 (void) /* La funcion f1 utiliza la variabe global. */
{
  K += K;
  return (K);
}
...
int f3 (void) /* La funcion f3 utiliza la variables estatica. */
{
 static int k = 8;
  K += 2;
  return (K);
...
int f4 (void) /* La funcion f4 utiliza dos variables ccon el mismo nombre: local y global */
