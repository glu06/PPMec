...
int RA4 = 0; 
int RA5 = 0;
/* El uso de variables globales no es muy recomendable. En estos problemas se utilizan unicamente con el objetivo de que e lector pueda observar la forma en que se aplican. */
void main (void )
{
  float CAL; 
...
void Rango (int VAL)
/* La llamada a funcion incrementa una variable dependiendo del valor del parametro VAL. */
