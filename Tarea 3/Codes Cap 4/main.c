...
/* Combinacion de variables globales y locales, parametros por valor de referencia. */
...
int main (void)
{
  int a;  /* Nota que a es ua variable local.*/
  a = 1;  /* Se asigna un valor a la variable local a.*/
  b = 2;  /* Se asigna un valor a la variables globales. b, c, y d. */
  c = 3;
  d = 4; 
  printf("\n%d %d %d %d", a, b, c, d );
funcion1(&b, &c); printf("\n%d %d %d %d", a, b, c, d );
