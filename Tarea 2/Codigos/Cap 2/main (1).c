...
/* Ventas descendentes.
  El programa, al recibir como dato tres valores que representan las ventas de los vendedores de una tienda de discos, escribe las ventas en orden descendente. 

  P, S y R: variables del tipo real.  */
