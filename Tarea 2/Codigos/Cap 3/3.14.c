...
/*Eleccion. 
El programa obtiene el total de votos de cada candidatos y el porcentaje correspondiente. 
...
void main (void)
{
  ...
  printf("\n\nCandidato 1: %d votos - - porcentajes: %5,2f", C1, PO1);
   
  printf("\n\nCandidato 2: %d votos - - porcentajes: %5,2f", C2, PO2);
 
  printf("\n\nCandidato 3: %d votos - - porcentajes: %5,2f", C3, PO3);
   
  printf("\n\nCandidato 4: %d votos - - porcentajes: %5,2f", C4, PO4);
  
  printf("\n\nCandidato 5: %d votos - - porcentajes: %5,2f", C5, PO5);
  
  printf("\nNulos:  %d votos - - porcentajes: %5,2f", NU, PON);
}